// Remove and Complete SVG Buttons
...
//if there is any text in the item field, add text to the to-do list
...
function completeItem() {
	...
	//checks if item should be added to todo or to completed list
	...
	//Item on todo list to be completed
